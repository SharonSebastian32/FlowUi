...
function PrevNext() {
  ...
  const calendarIconWrapperRef = useRef(null); // Ref for the wrapper element
  ...
  useEffect(() => {
    if (showCalendar && calendarIconWrapperRef.current) {
      const rect = calendarIconWrapperRef.current.getBoundingClientRect();
      setCalendarPosition({
    ...
    return (
      <div
        ...
        style={{
          ...
          left: `${calendarPosition.left}px`, // Fixed from 'right' to 'left'
          position: "absolute",
        }}
      >
    ...
    <>
      <div id="date-picker-container">
        ...
        >
          ...
          {/* Wrap the icon in a span and attach the ref to the span */}
          <span ref={calendarIconWrapperRef}>
            <FaCalendarAlt
              onClick={toggleCalendar}
              style={{ cursor: "pointer", color: "orange", fontSize: "1rem" }}
            />
          </span>
          <span
